...
AIが一次判断を支援し、人間が最終判断する問い合わせ対応フローを、登録から監査まで一貫して扱える業務アプリです。
...
- AIは補助であり、最終判断は人が行う
- 業務履歴を残して、あとから追えることを重視する
- 公開デモとローカル運用を分けて、安全に見せられる構成にする

## 処理フロー

問い合わせ登録 → AI分析 → 人間確認 → 対応 → 完了

AI分析では、問い合わせ本文をもとに次のような構造化結果を生成します。
